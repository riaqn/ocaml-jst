  ...
  | Val_prim p1 -> begin
     ...
     | Val_prim p2 -> begin
         ...
         let ty2_global =
           ...
           Option.iter (fun m -> Mode.Locality.submode_exn m.locality Mode.Locality.global) mode2 ;
           ty2
         in
         ...
         let ty2_local =
           let ty2, mode2 = Ctype.instance_prim_mode p2 vd2.val_type in
           Option.iter (fun m -> Mode.Locality.submode_exn Mode.Locality.local m.locality) mode2;
           ty2
         in
