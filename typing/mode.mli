...
module Locality : sig
  include module type of Modes.Locality 
    with type const = Modes.Locality.const 
    and type t = Modes.Locality.t
  val default : t
  val min_const : const
  val max_const : const
...
module Uniqueness : sig
  include module type of Modes.Uniqueness
    with type const = Modes.Uniqueness.const
    and type t = Modes.Uniqueness.t
  val default : t
  val min_const : const
  val max_const : const
  val le_const : const -> const -> bool
...
module Linearity : sig
  include module type of Modes.Linearity 
    with type const = Modes.Linearity.const 
    and type t = Modes.Linearity.t
  val min_const : const
  val max_const : const
  val le_const : const -> const -> bool
  val join_const : const -> const -> const
...
module Alloc : sig
  include module type of Modes.Alloc
    with type const = Modes.Alloc.const
    and type t = Modes.Alloc.t
  ...
  (* Force a mode variable to defaults *)
  val constrain_default : t -> const
